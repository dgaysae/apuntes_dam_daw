...
Es importante completar la documentación generada por Javadoc con **documentación de repositorio** (el famoso **README** de los repositorios de código escrito en Markdown) para el contexto del proyecto, ya que es muy importante documentar el "cómo empezar" y la arquitectura general a modo de instrucciones de arranque para otros desarrolladores.
