...
![ud01_prog_05_poo.png\|Comparativa entre prog. estructurada y POO sobre la relación de los datos y las operaciones que se realizan con ellos](/img/user/1DAM_Programaci%C3%B3n/attach/Unidad%2001/ud01_prog_05_poo.png)
...
<p><span>⬅️ <strong>Anterior:</strong> <a data-tooltip-position="top" aria-label="1DAM_Programación/Unidad 01/2. Resolución de problemas.md" data-href="1DAM_Programación/Unidad 01/2. Resolución de problemas.md" href="1DAM_Programación/Unidad 01/2. Resolución de problemas.md" class="internal-link" target="_blank" rel="noopener nofollow">2. Resolución de problemas</a> | 🏠 <strong>Unidad:</strong> <a data-tooltip-position="top" aria-label="1DAM_Programación/Unidades/Unidad 1 - Introducción a la programación con Java.md" data-href="1DAM_Programación/Unidades/Unidad 1 - Introducción a la programación con Java.md" href="1DAM_Programación/Unidades/Unidad 1 - Introducción a la programación con Java.md" class="internal-link" target="_blank" rel="noopener nofollow">Unidad 1 - Introducción a la programación con Java</a> | <strong>Siguiente:</strong> <a data-tooltip-position="top" aria-label="1DAM_Programación/Unidad 01/4. Los lenguajes de programación.md" data-href="1DAM_Programación/Unidad 01/4. Los lenguajes de programación.md" href="1DAM_Programación/Unidad 01/4. Los lenguajes de programación.md" class="internal-link" target="_blank" rel="noopener nofollow">4. Los lenguajes de programación</a> ➡️</span></p>
