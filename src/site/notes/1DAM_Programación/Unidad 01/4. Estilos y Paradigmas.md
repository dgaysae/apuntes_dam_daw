---
{"dg-publish":true,"permalink":"/1-dam-programacion/unidad-01/4-estilos-y-paradigmas/","tags":["conceptos_básicos","paradigmas"],"dg-note-properties":{"unidad":"[[1DAM_Programación/Unidades/Unidad 1 - Introducción a la programación con Java]]","descripcion":"Evolución de los lenguajes de programación desde sus inicios y, consecuentemente, de la forma de programar: crisis del software, programación estructurada, modular, orientada a objetos, etc.","orden":4,"tags":["conceptos_básicos","paradigmas"]}}
---
