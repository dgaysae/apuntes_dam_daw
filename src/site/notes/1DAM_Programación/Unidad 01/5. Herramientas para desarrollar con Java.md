...
<p><span>⬅️ <strong>Anterior:</strong> <a data-tooltip-position="top" aria-label="1DAM_Programación/Unidad 01/4. Los lenguajes de programación.md" data-href="1DAM_Programación/Unidad 01/4. Los lenguajes de programación.md" href="1DAM_Programación/Unidad 01/4. Los lenguajes de programación.md" class="internal-link" target="_blank" rel="noopener nofollow">4. Los lenguajes de programación</a> | 🏠 <strong>Unidad:</strong> <a data-tooltip-position="top" aria-label="1DAM_Programación/Unidades/Unidad 1 - Introducción a la programación con Java.md" data-href="1DAM_Programación/Unidades/Unidad 1 - Introducción a la programación con Java.md" href="1DAM_Programación/Unidades/Unidad 1 - Introducción a la programación con Java.md" class="internal-link" target="_blank" rel="noopener nofollow">Unidad 1 - Introducción a la programación con Java</a> | <strong>Siguiente:</strong> <a data-tooltip-position="top" aria-label="1DAM_Programación/Unidad 01/6. Qué es Java.md" data-href="1DAM_Programación/Unidad 01/6. Qué es Java.md" href="1DAM_Programación/Unidad 01/6. Qué es Java.md" class="internal-link" target="_blank" rel="noopener nofollow">6. Qué es Java</a> ➡️</span></p>
