...
int y;     // declaración
int z;     // declaración
x = 8;     // asignación de la constante 8 a x
y = 2;     // asignación de la constante 2 a y
z = x / y; // asignación de la expresión x/y a z
x = 5;     // asignación de la constante 5 a x
y = x + z; // asignación de la expresión x+z a y
```
