---
{"dg-publish":true,"permalink":"/1-dam-programacion/unidad-04/1-paquetes/","tags":["java/paquetes"],"dg-note-properties":{"unidad":"[[1DAM_Programación/Unidades/Unidad 4 - POO. Clases]]","descripcion":"¿Qué es eso de la POO (Programación Orientada a Objetos)? En este apartado se verán las nociones para entenderlo y los mecanismos que usa para mantener un estado (mediante atributos) y realizar acciones (mediante métodos).","orden":1,"tags":["java/paquetes"]}}
---
...
Los paquetes, como vimos en la [[6. Paquetes|unidad 3]], son **agrupaciones de clases**. 
...
<p><span>🏠 <strong>Unidad:</strong> <a data-tooltip-position="top" aria-label="1DAM_Programación/Unidades/Unidad 4 - POO. Clases.md" data-href="1DAM_Programación/Unidades/Unidad 4 - POO. Clases.md" href="1DAM_Programación/Unidades/Unidad 4 - POO. Clases.md" class="internal-link" target="_blank" rel="noopener nofollow">Unidad 4 - POO. Clases</a> | <strong>Siguiente:</strong> <a data-tooltip-position="top" aria-label="1DAM_Programación/Unidad 04/2. Las clases en OOP - divide y vencerás.md" data-href="1DAM_Programación/Unidad 04/2. Las clases en OOP - divide y vencerás.md" href="1DAM_Programación/Unidad 04/2. Las clases en OOP - divide y vencerás.md" class="internal-link" target="_blank" rel="noopener nofollow">2. Las clases en OOP - divide y vencerás</a> ➡️</span></p>
