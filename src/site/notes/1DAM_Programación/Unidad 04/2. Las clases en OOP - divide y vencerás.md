---
{"dg-publish":true,"permalink":"/1-dam-programacion/unidad-04/2-las-clases-en-oop-divide-y-venceras/","tags":["java/clases"],"dg-note-properties":{"unidad":"[[1DAM_Programación/Unidades/Unidad 4 - POO. Clases]]","descripcion":"¿Qué es eso de la POO (Programación Orientada a Objetos)? En este apartado se verán las nociones para entenderlo y los mecanismos que usa para mantener un estado (mediante atributos) y realizar acciones (mediante métodos).","orden":2,"tags":["java/clases"]}}
---
