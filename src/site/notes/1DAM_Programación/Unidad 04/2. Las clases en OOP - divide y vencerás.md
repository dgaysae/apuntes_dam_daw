---
{"dg-publish":true,"permalink":"/1-dam-programacion/unidad-04/2-las-clases-en-oop-divide-y-venceras/","tags":["java/clases"],"dg-note-properties":{"unidad":"[[Unidad 4 - POO. Clases]]","descripcion":"¿Qué es eso de la POO (Programación Orientada a Objetos)? En este apartado se verán las nociones para entenderlo y los mecanismos que usa para mantener un estado (mediante atributos) y realizar acciones (mediante métodos).","orden":2,"tags":["java/clases"]}}
---
...
![ud04_dac.png\|Clase vs Objeto](/img/user/1DAM_Programaci%C3%B3n/attach/Unidad%2004/ud04_dac.png)
...
class NaveEspacial {  
    ...
    public int setVidas(int vidas) {  
        // Aquí usamos this para distinguir el parámetro "vidas" del atributo "vidas"  
        this.vidas \= vidas;  
    }  
}
```

El **objeto super** es parecido a **this**, pero no se refiere al objeto actual, sino a la superclase o clase madre del objeto. Veremos más sobre superclases, clases madre y herencia en el resto de esta unidad. 
...
<p><span>⬅️ <strong>Anterior:</strong> <a data-tooltip-position="top" aria-label="1DAM_Programación/Unidad 04/1. Paquetes.md" data-href="1DAM_Programación/Unidad 04/1. Paquetes.md" href="1DAM_Programación/Unidad 04/1. Paquetes.md" class="internal-link" target="_blank" rel="noopener nofollow">1. Paquetes</a> | 🏠 <strong>Unidad:</strong> <a data-tooltip-position="top" aria-label="1DAM_Programación/Unidades/Unidad 4 - POO. Clases.md" data-href="1DAM_Programación/Unidades/Unidad 4 - POO. Clases.md" href="1DAM_Programación/Unidades/Unidad 4 - POO. Clases.md" class="internal-link" target="_blank" rel="noopener nofollow">Unidad 4 - POO. Clases</a> | <strong>Siguiente:</strong> <a data-tooltip-position="top" aria-label="1DAM_Programación/Unidad 04/3. ¿De clase o de instancia?.md" data-href="1DAM_Programación/Unidad 04/3. ¿De clase o de instancia?.md" href="1DAM_Programación/Unidad 04/3. ¿De clase o de instancia?.md" class="internal-link" target="_blank" rel="noopener nofollow">3. ¿De clase o de instancia?</a> ➡️</span></p>
