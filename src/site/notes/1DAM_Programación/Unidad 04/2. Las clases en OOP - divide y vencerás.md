...
El **objeto `super`** es parecido a **`this`**, pero no se refiere al objeto actual, sino a la **superclase o clase madre** del objeto. Veremos más sobre superclases, clases madre y herencia [[8. Herencia|más adelante]] en esta unidad. 
