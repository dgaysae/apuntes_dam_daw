---
{"dg-publish":true,"permalink":"/1-dam-programacion/unidad-05/4-cadenas-o-strings/","tags":["java/string"],"dg-note-properties":{"unidad":"[[1DAM_Programación/Unidades/Unidad 5 - Estructuras de almacenamiento]]","descripcion":"Una cadena de texto es un array de caracteres. Pero, al tratarse de un objeto, ofrece muchas funcionalidades ya implementadas en la API de Java. Veamos algunas de ellas.","orden":4,"tags":["java/string"]}}
---
...
> [!note] Nota
> Recuerda que en la [[Unidad 3 - POO. Los objetos|unidad 3]], en el apartado [[3. Ejemplos de la API - Math y String]], comentamos algunos de los métodos más habituales de la clase `String`.
...
## 4.5. Para más información...

Para más información, puedes consultar el apartado de Referencias:

<div class="transclusion internal-embed is-loaded"><a class="markdown-embed-link" href="/1-dam-programacion/unidad-05/referencias/#string" aria-label="Open link"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="svg-icon lucide-link"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"></path><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"></path></svg></a><div class="markdown-embed">
...
<p><span>⬅️ <strong>Anterior:</strong> <a data-tooltip-position="top" aria-label="1DAM_Programación/Unidad 05/3. Arrays bidimensionales (matrices).md" data-href="1DAM_Programación/Unidad 05/3. Arrays bidimensionales (matrices).md" href="1DAM_Programación/Unidad 05/3. Arrays bidimensionales (matrices).md" class="internal-link" target="_blank" rel="noopener nofollow">3. Arrays bidimensionales (matrices)</a> | 🏠 <strong>Unidad:</strong> <a data-tooltip-position="top" aria-label="1DAM_Programación/Unidades/Unidad 5 - Estructuras de almacenamiento.md" data-href="1DAM_Programación/Unidades/Unidad 5 - Estructuras de almacenamiento.md" href="1DAM_Programación/Unidades/Unidad 5 - Estructuras de almacenamiento.md" class="internal-link" target="_blank" rel="noopener nofollow">Unidad 5 - Estructuras de almacenamiento</a> | <strong>Siguiente:</strong> <a data-tooltip-position="top" aria-label="1DAM_Programación/Unidad 05/5. Expresiones regulares.md" data-href="1DAM_Programación/Unidad 05/5. Expresiones regulares.md" href="1DAM_Programación/Unidad 05/5. Expresiones regulares.md" class="internal-link" target="_blank" rel="noopener nofollow">5. Expresiones regulares</a> ➡️</span></p>
