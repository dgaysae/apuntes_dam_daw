...
> [!warning] Cuidado 
> Con el `when` ocurre lo mismo que con el **`if` [[2DAM_PMDM/Unidad 01/10. Control de flujo#^7e7e7e\|cuando se usa como una expresión]]**: debe incluir **obligatoriamente** el `else` para que la expresión siempre devuelva un valor.
...
Lo habitual es hacerlo [[2DAM_PMDM/Unidad 01/9. Rangos#Listas de elementos\|con rangos]], como hemos visto en apartados anteriores.
