...
Para comparar si son estructuralmente iguales de forma profunda, esto es, que tengan el **mismo tamaño** y que los arrays que contienen en cada posición son iguales (ver [[3. Tipos de datos#`contentEquals()`]]. Como puede deducirse, también devuelve `true` o `false`.
