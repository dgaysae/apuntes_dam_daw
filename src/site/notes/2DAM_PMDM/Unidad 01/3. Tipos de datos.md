...
<iframe src="https://pl.kotl.in/oUuZrfB8R" width="560" height="250"></iframe>
...
Pero la más llamativa, la que tantos problemas suele dar en Java, es la **comparación de cadenas**. Mientras que en Java hay que usar el método `.equals()` para ver si dos cadenas son iguales, **¡ en Kotlin se puede usar el comparador \=\= !**
...
> [!info]  
> El operador \=\= hace una **[[6. Comparadores estructurales y referenciales#Comparadores estructurales|comparación estructural]]**, que estudiaremos más adelante.
