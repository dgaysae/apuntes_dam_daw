...
A la hora de comparar dos listas (ver [[5. Comparadores estructurales y referenciales]]), se consideran estructuralmente iguales (\=\=) si tienen el **mismo tamaño** y los **mismos elementos** en las **mismas posiciones**.

A diferencia de Java, Kotlin permite declarar listas de [[6. Collections#^27e072|dos formas]] (mutables e inmutables) con métodos muy similares, sin especificar una estructura concreta.
