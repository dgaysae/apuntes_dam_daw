...
Kotlin, en cambio, tiene un sistema de seguridad de nulos para evitar este tipo de errores. Esto se logra al comprobar la posibilidad de nulos en tiempo de compilación, en lugar de dejarlo para el tiempo de ejecución.
...
En este ejemplo, se está intentando asignar `null` a una variable de tipo `String`pero, como hemos dicho antes, Kotlin no lo admite.
