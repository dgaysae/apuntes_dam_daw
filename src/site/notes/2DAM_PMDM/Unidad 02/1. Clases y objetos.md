...
En Kotlin podríamos implementar *setters* y *getters* tal y como se hace en Java. Así, para el ejemplo anterior:
...
Como las **propiedades** de una clase son **públicas por defecto**, no necesitan ni *setters* ni *getters*. Es decir, esto:
