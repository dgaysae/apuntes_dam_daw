...
[^1]:  Animaciones y transiciones. (s. f.). Android Developers. [https://developer.android.com/develop/ui/views/animations?hl=es](https://developer.android.com/develop/ui/views/animations?hl=es)
