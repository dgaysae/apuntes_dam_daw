---
{"dg-publish":true,"permalink":"/ciclos/daw/","dg-note-properties":{"titulo":"Desarrollo de Aplicaciones Multiplataforma","tipo":"[[CFGS]]","cursos":["[[Ciclos/CursosDAW/1º DAW]]","[[Ciclos/CursosDAW/2º DAW]]"],"descripcion":"Este ciclo de grado superior está enfocado al desarrollo de software en distintas plataformas (escritorio, móvil o incluso web)"}}
---
...
Por supuesto, estos contenidos se hacen de acuerdo a lo estipulado en la **[[Ciclos/DAW#Normativa vigente\|normativa vigente]]** y enfocándose en las **[[Finalidades\|finalidades]]** establecidas para la FP a las que contribuye cada material.
...
| File                                   | Descripción                                                                                                                                                                                                                              |
| -------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [[Ciclos/CursosDAW/1º DAW\|1º DAW]] | Este curso se centra en los fundamentos del desarrollo: programación en Java, lenguajes de marcas para la web... atentiendo también a conceptos fundamentales como el funcionamiento de un sistema informático o el entorno empresarial. |
| [[Ciclos/CursosDAW/2º DAW\|2º DAW]] | Entra ya en materias más cercanas al mundo real: programación front-end y back-end, puesta en producción, etc.                                                                                                                           |
