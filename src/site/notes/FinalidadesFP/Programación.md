...
El perfil profesional del título de este ciclo lo determinan su [[FinalidadesFP/Programación#Competencia general\|competencia general]], sus [[FinalidadesFP/Programación#Competencias profesionales, personales y sociales\|competencias profesionales, personales y sociales]], y por la relación de cualificaciones y, en su caso, unidades de competencia del Catálogo Nacional de Cualificaciones Profesionales incluidas en el título.
...
1. **Escribe y prueba programas sencillos, reconociendo y aplicando los fundamentos de la programación orientada a objetos.**
...
1. **Escribe y depura código, analizando y utilizando las estructuras de control del lenguaje.**
...
1. **Desarrolla programas organizados en clases analizando y aplicando los principios de la programación orientada a objetos.**
...
1. **Realiza operaciones de entrada y salida de información, utilizando procedimientos específicos del lenguaje y librerías de clases.**
...
1. **Escribe programas que manipulen información seleccionando y utilizando tipos avanzados de datos.**
...
1. **Desarrolla programas aplicando características avanzadas de los lenguajes orientados a objetos y del entorno de programación.**
...
1. **Utiliza bases de datos orientadas a objetos, analizando sus características y aplicando técnicas para mantener la persistencia de la información.**
...
1. **Gestiona información almacenada en bases de datos relacionales manteniendo la integridad y consistencia de los datos.**
