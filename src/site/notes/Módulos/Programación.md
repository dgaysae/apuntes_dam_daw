...
|**RA5.** Realiza operaciones de **entrada y salida** de información mediante procedimientos específicos y librerías.|a) Uso de la consola para E/S.<br>b) Aplicación de formatos de visualización.<br>c) Reconocimiento de librerías de E/S.<br>d) Uso de ficheros para almacenamiento.<br>e) Métodos de acceso al contenido de ficheros.<br>f) Creación de interfaces gráficas simples (GUI).<br>g) Programación de controladores de eventos.<br>h) Programas con interfaces gráficas.|**Lectura y escritura de información (e Interfaces):**<br>- Flujos (bytes y caracteres) y tipos de ficheros.<br>- Apertura, cierre y modos de acceso a ficheros.<br>- Creación de interfaces y controladores de eventos.<br>- Entrada desde teclado y salida formateada a pantalla.|
|**RA6.** Escribe programas que manipulen información utilizando **tipos avanzados de datos**.|a) Uso de matrices (arrays).<br>b) Reconocimiento de librerías de datos avanzados.<br>c) Uso de listas para procesar información.<br>d) Uso de iteradores.<br>e) Ventajas de las distintas colecciones.<br>f) Creación de clases y métodos genéricos.<br>g) Uso de expresiones regulares.<br>h) Identificación de clases para intercambio de datos.<br>i) Programas que manipulan documentos de intercambio.<br>j) Operaciones agregadas en colecciones.|**Aplicación de las estructuras de almacenamiento:**<br>- Estructuras estáticas (arrays) y dinámicas.<br>- Arrays multidimensionales.<br>- Genericidad y colecciones (Listas, Conjuntos, Diccionarios).<br>- Cadenas de caracteres (String) y expresiones regulares.<br>- Operaciones agregadas (filtrado, reducción).|
|**RA7.** Desarrolla programas aplicando **características avanzadas** de POO y del entorno de programación.|a) Conceptos de herencia, superclase y subclase.<br>b) Modificadores para bloquear/forzar herencia.<br>c) Incidencia de constructores en herencia.<br>d) Sobrescritura de métodos.<br>e) Diseño de jerarquías de clases.<br>f) Prueba y depuración de jerarquías.<br>g) Implementación de programas con jerarquías.<br>h) Documentación de código.<br>i) Escenarios de uso de interfaces.<br>j) Herencia vs. Composición.|**Utilización avanzada de clases:**<br>- Composición, herencia y polimorfismo.<br>- Jerarquía de clases: superclases y subclases.<br>- Clases y métodos abstractos y finales.<br>- Interfaces y sobrescritura de métodos.|
