---
{"dg-publish":true,"permalink":"/programacion-1-dam/unidad-03/2-definiciones-formales/","tags":["poo/herencia","java","poo/teoría","poo/abstracción","poo/polimorfismo","poo/encapsulamiento"],"dg-note-properties":{"unidad":"[[Unidad 3 - POO. Los objetos]]","descripcion":"¿Qué es eso de la POO (Programación Orientada a Objetos)? En este apartado se verán las nociones para entenderlo y los mecanismos que usa para mantener un estado (mediante atributos) y realizar acciones (mediante métodos).","orden":2,"tags":["poo/herencia","java","poo/teoría","poo/abstracción","poo/polimorfismo","poo/encapsulamiento"]}}
---
