---
{"dg-publish":true,"permalink":"/programacion-1-dam/unidad-03/2-definiciones-formales/","tags":["poo/herencia","poo/teoría","poo/abstracción","poo/polimorfismo","poo/encapsulamiento","java/Math","java/string"],"dg-note-properties":{"unidad":"[[Unidad 3 - POO. Los objetos]]","descripcion":"¿Qué es eso de la POO (Programación Orientada a Objetos)? En este apartado se verán las nociones para entenderlo y los mecanismos que usa para mantener un estado (mediante atributos) y realizar acciones (mediante métodos).","orden":2,"tags":["poo/herencia","poo/teoría","poo/abstracción","poo/polimorfismo","poo/encapsulamiento","java/Math","java/string"]}}
---
...
<p><span>⬅️ <strong>Anterior:</strong> <a data-tooltip-position="top" aria-label="Programación_1DAM/Unidad 03/1. Entendiendo la programación orientada a objetos.md" data-href="Programación_1DAM/Unidad 03/1. Entendiendo la programación orientada a objetos.md" href="Programación_1DAM/Unidad 03/1. Entendiendo la programación orientada a objetos.md" class="internal-link" target="_blank" rel="noopener nofollow">1. Entendiendo la programación orientada a objetos</a> | 🏠 <strong>Unidad:</strong> <a data-tooltip-position="top" aria-label="Programación_1DAM/Unidades/Unidad 3 - POO. Los objetos.md" data-href="Programación_1DAM/Unidades/Unidad 3 - POO. Los objetos.md" href="Programación_1DAM/Unidades/Unidad 3 - POO. Los objetos.md" class="internal-link" target="_blank" rel="noopener nofollow">Unidad 3 - POO. Los objetos</a> | <strong>Siguiente:</strong> <a data-tooltip-position="top" aria-label="Programación_1DAM/Unidad 03/3. Ejemplos de la API - Math y String.md" data-href="Programación_1DAM/Unidad 03/3. Ejemplos de la API - Math y String.md" href="Programación_1DAM/Unidad 03/3. Ejemplos de la API - Math y String.md" class="internal-link" target="_blank" rel="noopener nofollow">3. Ejemplos de la API - Math y String</a> ➡️</span></p>
