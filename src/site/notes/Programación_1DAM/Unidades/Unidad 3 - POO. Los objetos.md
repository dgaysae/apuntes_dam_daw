...
| [[Programación_1DAM/Unidad 03/3. Ejemplos de la API - Math y String\|3. Ejemplos de la API - Math y String]]                                             | Una cadena de texto es un array de caracteres. Pero, al tratarse de un objeto, ofrece muchas funcionalidades ya implementadas en la API de Java. Veamos algunas de ellas.                                                      |
